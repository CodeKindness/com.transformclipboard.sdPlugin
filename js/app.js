...
function connected (jsn) {
	...
	$SD.on('com.transformclipboard.action.willAppear', jsonObj =>
			diceAction.onWillAppear(jsonObj)
	);
	$SD.on('com.transformclipboard.action.keyDown', jsonObj =>
			diceAction.onKeyDown(jsonObj)
	);
	$SD.on('com.transformclipboard.action.keyUp', jsonObj =>
			diceAction.onKeyUp(jsonObj)
	);
	$SD.on('com.transformclipboard.action.sendToPlugin', jsonObj =>
...
var diceAction = {
	type : "com.transformclipboard.action",
